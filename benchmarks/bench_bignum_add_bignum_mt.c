...
int main(int argc, char **argv)
{
    ...
    bignum_add_bignum_benchmark_status_t adapter_status;
    benchmark_core_status_t core_status;

    adapter_status = bignum_add_bignum_benchmark_adapter_init(&adapter);
    if (adapter_status != BIGNUM_ADD_BIGNUM_BENCHMARK_STATUS_SUCCESS) return EXIT_FAILURE;
